          ...
          <Row>
            <Col>
                ...
                <Row>
                  <Col lg="4" className="ip-occurrences">
                    <Table>
                      ...
                      <tbody>
                          {
                            Object.keys(this.props.state.ips.v6.chart.occurrences.history).map((item, index) => {
                              return (<tr key={index}>
                                <td>{item}</td>
                                <td>{this.props.state.ips.v6.chart.occurrences.history[item]}</td>
                              </tr>)
                            })
                          }
                      </tbody>
                  ...
                  <Col lg="8">
                    <Polar data={this.props.state.ips.v6.chart.occurrences} options={polar} redraw />
                  </Col>
                </Row>
              </Card>
              <Card body className="mt-3">
                ...
                <Row>
                  <Col lg="12">
                    <HorizontalBar data={this.props.state.ips.v6.chart.endpoints} height={350} width={null} options={horizontalBar} redraw />
                  </Col>
                  <Col lg="12" className="ip-endpoints">
                    <Table>
                      ...
                      <tbody>
                          {
                            this.props.state.ips.v6.chart.endpoints.history.map((item, index) => {
                              return (<tr key={index}>
                                <td>{index + 1}</td>
                                <td>{item.ip}</td>
                                <td>{item.packets}</td>
